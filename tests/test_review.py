...
class TestReview(unittest.TestCase):
    ...
    def setUp(self):
        self.new_review = Review(movie_id=12345,title='Review for movies',imageurl="https://image.tmdb.org/t/p/w500/jdjdjdjn",review='This movie is the best thing since sliced bread')
